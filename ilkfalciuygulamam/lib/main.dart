        ...
        child: Column(
          ...
          children: [
            SizedBox(
              width: 150,
              height: 150,
              child: Image.asset("imagess/falci.png"),
            ),
            Card(
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: const Text("PARA DURUMU",style: TextStyle(color: Colors.green)),
                onTap: () {
                  setState(() {
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: const Text("GÜNLÜK TAVSİYE",style: TextStyle(color: Colors.blue)),
                onTap: () {
                  setState(() {
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Text(yanitlar[yanitIndex],style: const TextStyle(fontSize: 16,color: Colors.white),textAlign: TextAlign.center),
              ),
            )
      ],
        ),
